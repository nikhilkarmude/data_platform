...
class ABC:
    ...
    def get_table(self, table_name: str) -> Table:
        ...
        Example Usage:
        table = abc.get_table("SYSTEM_CONTROL_TBL")
        """
        logger.info(f"Fetching table: {table_name}")
        metadata = MetaData()
        table = Table(table_name, metadata, autoload_with=self.get_engine(), schema='public')
        logger.info(f"Fetched table: {table}")
        return table

    def get_table_data(self, table_name: str, where_conditions: dict = None) -> list:
        ...
        results = abc.get_table_data("SYSTEM_CONTROL_TBL")
        for row in results:
            print(row)
        ...
        results = abc.get_table_data("SYSTEM_CONTROL_TBL", where_conditions)
        for row in results:
            print(row)
        """
    ...
    def update_data(self, table_name: str, where_conditions: dict, my_val: dict) -> None:
    ...
    def delete_data(self, table_name: str, where_conditions: dict) -> None:
